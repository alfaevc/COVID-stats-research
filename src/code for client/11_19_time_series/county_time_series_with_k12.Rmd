...
plot_time_interact <- function(state, county, window_num, days_diff, space_desc,
  ...
  p <- ggplotly(plot3, tooltip=c("Date", "New_Cases", "descript","score")) %>%
    layout(legend=list(title=list(text='<b> Event</b>')))
  
  # remove score legend
  p <- style(p, showlegend = FALSE, traces=c(no_score_legend_lower:no_score_legend_upper))
...
days_diff = 10
space_desc = 15
label_position_offset = -40
y_axis_max = 80
k12_text_y = 60
no_score_legend_lower = 18
no_score_legend_uppper = 33
